...
_G.packer_plugins = {
  ["Comment.nvim"] = {
    ...
    loaded = true,
    path = "/home/buhrjk/.local/share/nvim/site/pack/packer/start/Comment.nvim",
  ...
  ["cmp-tmux"] = {
    loaded = true,
    path = "/home/buhrjk/.local/share/nvim/site/pack/packer/start/cmp-tmux",
  ...
  ["gitsigns.nvim"] = {
    ...
    loaded = true,
    path = "/home/buhrjk/.local/share/nvim/site/pack/packer/start/gitsigns.nvim",
  ...
  ["impatient.nvim"] = {
    loaded = true,
    path = "/home/buhrjk/.local/share/nvim/site/pack/packer/start/impatient.nvim",
  ...
  ["nvim-dap"] = {
    loaded = true,
    path = "/home/buhrjk/.local/share/nvim/site/pack/packer/start/nvim-dap",
